                    ...
                    <p>
                        ...
                        <asp:Table ID="Table1" runat="server" CellSpacing="30" CellPadding="10" >
                            ...
                            <asp:TableRow>
                                ...
                                <asp:TableCell >
                                    Assignment 2 <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Auth/FIT5192-A2-2016_Specification.pdf">(Assignment Specification)</asp:HyperLink>
                                </asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                            ...
                            <asp:TableRow>
                                ...
                                <asp:TableCell >
                                    ...
                                    Wang Sen: Login,registration,search users,show source code
                                </asp:TableCell>
                            </asp:TableRow>
                        </asp:Table>
                    </p>
